...
#### Variables from FT ICR MS analysis
- GFE : Gibb's free energy
- NOSC : Nominal oxidation state of carbon
- AI_mod : Modified aromiticity index
- DBE_1 : Double bond equivalent
- h.c.wtavg : Hydrogen to carbon ratio as a weighted average
